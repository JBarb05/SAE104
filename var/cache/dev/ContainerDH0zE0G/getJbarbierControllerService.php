 ...
 */
class getJbarbierControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\JbarbierController' shared autowired service.
     *
     * @return \App\Controller\JbarbierController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'JbarbierController.php';

        $container->services['App\\Controller\\JbarbierController'] = $instance = new \App\Controller\JbarbierController();
        ...
        ]))->withContext('App\\Controller\\JbarbierController', $container));
